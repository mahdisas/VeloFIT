...
/** veloFIT wordmark. `compact` renders only the logo tile (collapsed sidebar). */
export function BrandLogo({ compact = false }: { compact?: boolean }) {
  return (
    <div className="flex items-center gap-2" aria-label="veloFIT">
...
/** Lucide has no brand icons, so WhatsApp ships as a local SVG. */
